   ...
   <footer
      ...
      <div class="container">
         <div class="footer__grid">
            ...
            <nav class="footer__catalog">
               ...
               <ul class="footer__catalog-nav">
                  <li
                     v-for="item in nav.firstNav"
                     class="footer__catalog-nav-item"
                     :key="item.id">
                     <router-link
                        class="footer__catalog-nav-link transition"
                        :to="item.to">
                        {{ item.name }}
                     </router-link>
                  </li>
            ...
            <nav class="footer__client">
               ...
               <ul class="footer__client-nav">
                  <li
                     v-for="item in nav.secondNav"
                     class="footer__client-nav-item"
                     :key="item.id">
                     <router-link
                        class="footer__catalog-nav-link transition"
                        :to="item.to">
            ...
            <div class="footer__contact">
               ...
               <a
                  class="footer__contact-tel transition"
                  href="tel:9999999999">
                  +9 (999) 999 99 99
               </a>
               <p class="footer__contact-tel-text">Поможем с выбором</p>
               <a
                  class="footer__contact-email transition"
               ...
               <div class="footer__social">
                  <a
                     ...
                     href="https://instagram.com/lumiiere.candles?igshid=YmMyMTA2M2Y="
                  ...
                  <a
                     class="footer__social-link"
                     href="https://vt.tiktok.com/ZSdGUYsFb/"
                     aria-label="Social link">
                     <svg class="footer__social-icon">
                  ...
                  <a
                     class="footer__social-link"
                     href="https://t.me/lumiiere_candles"
                     aria-label="Social link">
                     <svg class="footer__social-icon">
                  ...
                  <a
                     class="footer__social-link"
                     href="https://taplink.cc/lumiierecandles"
                     aria-label="Social link">
                     <svg class="footer__social-icon">
         ...
         <div class="footer__info">
            ...
            <a
               class="footer__dev transition"
               href="https://github.com/suchkovcode/">
               Разработка сайта
            </a>
         </div>
      </div>
