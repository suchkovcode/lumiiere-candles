<template>
   <div class="btncount">
      <button class="btncount__minus" aria-label="Btn card minus" @click="countIncrement"></button>
      <p class="btncount__value">{{ countItem }}</p>
      <button class="btncount__plus" aria-label="Btn card plus" @click="countDecrement"></button>
   </div>
</template>
