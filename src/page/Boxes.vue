<template>
   <section class="boxes">
      <div class="container">
         <BaseBreadcrumbs class="boxes__breadcrumbs" :roterLink="roterData" />
         <div class="boxes__header">
            <img class="boxes__header-icon" src="@/assets/img/svg/boxes__header-icon.svg" alt="Главная картинка" width="85" height="40" />
