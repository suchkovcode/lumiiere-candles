<template>
   <section class="goods">
      <div class="container">
         <BaseBreadcrumbs class="goods__breadcrumbs" :roterLink="roterData" />
         <div class="goods__header">
            <img class="goods__header-icon" src="@/assets/img/svg/catalog__header-icon.svg" alt="Главная картинка" width="85" height="40" />
